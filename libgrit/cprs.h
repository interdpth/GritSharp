...
u32	cprs_create_header(unsigned int size, u8 tag); 

bool cprs_compress(RECORD *dst, const RECORD *src, ECprsTag tag);
bool cprs_decompress(RECORD *dst, const RECORD *src);


unsigned int fake_compress(RECORD *dst, const RECORD *src);
unsigned int fake_decompress(RECORD *dst, const RECORD *src);

unsigned int lz77gba_compress(RECORD *dst, const RECORD *src);
unsigned int lz77gba_decompress(RECORD *dst, const RECORD *src);

unsigned int huffgba_compress(RECORD *dst, const RECORD *src, int srcB);
//unsigned int huf4gba_compress(RECORD *dst, const RECORD *src);
unsigned int huf8gba_compress(RECORD *dst, const RECORD *src);

unsigned int rle8gba_compress(RECORD *dst, const RECORD *src);
unsigned int rle8gba_decompress(RECORD *dst, const RECORD *src);
